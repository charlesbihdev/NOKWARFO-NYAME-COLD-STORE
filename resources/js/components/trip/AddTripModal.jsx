...
function AddTripModal({ isOpen, onClose, products = [], suppliers = [], errors = {} }) {
    ...
    const { data, setData, post, processing, reset, clearErrors } = useForm({
        ...
        other_expenses: '',
        notes: '',
        items: [{ product_name: '', quantity: 1, unit_cost_price: 0, unit_selling_price: 0 }],
    });

    useEffect(() => {
        if (isOpen) {
            const initialItems = [{ product_name: '', supplier_name: '', quantity: 1, unit_cost_price: 0, unit_selling_price: 0 }];
    ...
    function handleSubmit(e) {
        ...
        post(route('trip-estimations.store'), {
            onSuccess: () => {
                reset();
                clearErrors();
                setItems([{ product_name: '', supplier_name: '', quantity: 1, unit_cost_price: 0, unit_selling_price: 0 }]);
                onClose();
            },
            preserveScroll: true,
            preserveState: true,
    ...
    function addItem() {
        const newItems = [...items, { product_name: '', supplier_name: '', quantity: 1, unit_cost_price: 0, unit_selling_price: 0 }];
        setItems(newItems);
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-h-[95vh] w-[95vw] max-w-none overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>Add Trip Estimation</DialogTitle>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            >
                                ...
                                Add Product
                                                 ...
                                                 {/* Desktop Column Headers - Better spacing */}
                                            ...
                                            <div>
                                                ...
                                                <Select
                                                    ...
                                                    onValueChange={(supplierId) => {
                                                        ...
                                                        if (supplier) {
                                                            updateItem(index, 'supplier_name', supplier.name);
                                                        }
                                                    }}
                                                >
                                                    <SelectTrigger className="mt-1">
                                                ...
                                                <div>
                                                    ...
                                                    <Input
                                                        ...
                                                        onChange={(e) => updateItem(index, 'unit_cost_price', e.target.value)}
                                                        min="0"
                                                        required
                                                        className="mt-1"
                                                    />
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <Input
                                                        ...
                                                        onChange={(e) => updateItem(index, 'unit_selling_price', e.target.value)}
                                                        min="0"
                                                        required
                                                        className="mt-1"
                                                    />
                                                 ...
                                                 <div className={`mt-1 flex h-16 w-full rounded-md border-2 py-3 text-lg font-bold items-center justify-center ${
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Creating...' : 'Create Trip Estimation'}
                        </Button>
                    </div>
                </form>
            </DialogContent>
