...
export default function DebtModal({ supplier, open, onOpenChange }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('suppliers.debts.store', supplier.id), {
            onSuccess: () => {
                onOpenChange(false);
                reset();
            },
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Record a debt entry for {supplier.name}. This can be a previous debt or any outstanding amount.</DialogDescription>
                </DialogHeader>
